...
int main(int argc, char *argv[])
{
	...
	while (choice != 99)
	{
		...
		case 43:
		{
			puts("You've entered Room 43, Katherine's Boutique!");
			room43();
			break;
		}
		case 44:
...
void room43(void)
{
    ...
    int pantsChoice = 0, shirtChoice = 0, jacketChoice = 0, shoeChoice = 0, accessoryChoice = 0;
    int jewelrySubChoice = 0;
    bool shirtSelected = false, pantsSelected = false, jacketSelected = false, shoeSelected = false, accessorySelected = false;
    srand(time(NULL));

    printf("\nWelcome Katherine’s Boutique!\n");
    printf("To save yourself you need to create a gorge-tastic outfit!\n");
    printf("To create your glamtacular outfit, please choose one of the chic-mazing items from our stunning inventory:\n");

    while (!shirtSelected || !pantsSelected || !jacketSelected || !shoeSelected || !accessorySelected)
    {
        ...
        if (choice == 1 && !shirtSelected)
        {
            printf("\nYou chose our totally fab Shirts! Please choose a cute shirt type:\n");
            printf("1. Long Sleeve\n2. Short Sleeve\n3. Tank Top\n4. Tube Top\n");
            printf("Enter your choice (1-4): ");
            scanf("%d", &shirtChoice);

            if (shirtChoice == 1 || shirtChoice == 2)
            {
                printf("\nPick a chic neckline for your fab shirt:\n");
                printf("1. Turtleneck\n2. Scoop Neck\n3. Heart Neck\n4. Square Neck\n");
                printf("Enter your choice (1-4): ");
                scanf("%d", &subChoice);
            }
        ...
        else if (choice == 2 && !pantsSelected)
        {
            printf("\nYou chose our flawless Pants! Please choose a gorgeous pant type:\n");
            printf("1. Leggings\n2. Jeans\n3. Shorts\n4. Skirt\n");
            printf("Enter your choice (1-4): ");
            scanf("%d", &pantsChoice);
            ...
            if (pantsChoice == 2)
            {
                printf("\nPick what stylish jeans you’d like:\n");
                printf("1. Flare\n2. Skinny\n3. Bootcut\n4. Straight\n");
                printf("Enter your choice (1-4): ");
                scanf("%d", &subChoice);
            }
            else if (pantsChoice == 3)
            {
                printf("\nPick the purrfect length for your shorts:\n");
                printf("1. Mini Short\n2. Capri Short\n3. Cargo Short\n4. Biker Short\n");
                printf("Enter your choice (1-4): ");
                scanf("%d", &subChoice);
            }
            else if (pantsChoice == 4)
            {
                printf("\nPick the purrfect length for your skirt:\n");
                printf("1. Maxi\n2. Midi\n3. Mini\n");
        ...
        else if (choice == 3 && !jacketSelected)
        {
            printf("\nYou chose our couture-rific Jackets! Please choose a type:\n");
            printf("1. Denim Jacket\n2. Leather Jacket\n3. Cardigan\n4. Hoodie\n");
            printf("Enter your choice (1-4): ");
            scanf("%d", &jacketChoice);
            jacketSelected = true;
        }
        else if (choice == 4 && !shoeSelected)
        {
            printf("\nYou chose our trend-tastic Shoes! Please choose a cute shoe type:\n");
            printf("1. High Heels\n2. Flats\n3. Boots\n4. Flip Flops\n5. Sneakers\n");
            printf("Enter your choice (1-5): ");
            scanf("%d", &shoeChoice);
            shoeSelected = true;
        }
        else if (choice == 5 && !accessorySelected)
        {
            printf("\nYou chose bing-tastic Accessories! Please choose an elegan-tastic accessory:\n");
            printf("1. Purse\n2. Scarf\n3. Glasses\n4. Hair Piece\n5. Jewelry\n");
            printf("Enter your choice (1-5): ");
            scanf("%d", &accessoryChoice);

            if (accessoryChoice == 5)
            {
                printf("\nYou chose Jewelry! Please select the type of jewelry:\n");
                printf("1. Necklace\n2. Bracelet\n3. Ring\n4. Earrings\n");
                printf("Enter your choice (1-4): ");
                scanf("%d", &jewelrySubChoice);
            }
            accessorySelected = true;
        }
        else
        {
            printf("\nPlease choose a valid option or an item you haven't selected yet.\n");
        }
    }
    ...
    int outfitQuality = rand() % 2;
    const char *outfitOutcomes[] = {
        "This outfit isn't quite right. It’s not **fab-tacular**.",
        "Not quite the right look... maybe try something else? It’s not **gorgetastic**.",
        "Oops! This outfit needs a little more sparkle. Try again?",
        "It’s close, but not quite **fash-tacular**. A bit more shine, maybe!"};
    const char *positiveFeedback[] = {
        "You look **gorgetastic**!",
        "Your outfit is **totally fab**!",
        "That outfit is **chic-mazing**!",
        "Totally **bling-tastic**! You nailed it!"};

    if (outfitQuality == 1)
    {
        int randomFeedback = rand() % 4;
        printf("\nWIN! Your outfit is amazing! %s\n", positiveFeedback[randomFeedback]);
        printf("\nCongratulations, you saved yourself and escaped Room 43!\n");
    }
    else
    {
        int randomOutcome = rand() % 4;
        printf("\nLOSE! %s\n", outfitOutcomes[randomOutcome]);
        printf("\nOops, you didn't escape Room 43. Would you like to try again or exit?\n");
        printf("1. Try again\n2. Exit\n");
        int retryChoice;
        scanf("%d", &retryChoice);
        ...
        if (retryChoice == 1)
        {
            printf("\nLet’s try again! Choose your outfit...\n");
            room43();
        }
        else
        {
...
void user14room(void)
{
	...
	if (yesCounter >= 3)
	{
		...
		printf("Your soul is corrupt. A -100 debuff has been applied to you. What have you learned about yourself today?");
...
void room39game(void)
{
	// passphrase made of words I grabbed from a NYT Crossword puzzle @ 'https://urldefense.com/v3/__https://www.xwordinfo.com/Crossword?date=7*31*2024__;Ly8!!P7nkOOY!tberoA6xJT-WYw9tV1QYTFGrrH2kMVvbdIoWkC7TtM2Yk4vyzE3ZwClavErKz6toVsF-8i1edYZTF9UkvOfAQsTjh5SRvm5Z7yzRbw$ '
...
void room6game(void)
{
	...
	scanf("%d", &nextchoice);
	printf("After picking it up, you hear a voice in your head telling you to call its name. [Enter a Name]\n");
	scanf("%s", itsname);
	// printf("%s", itsname);
	...
	{
		printf("The plan was risky, and you pay for it as you watch the bug creature grab %s and throw them at you, dropping you both to the ground. \n%s is knocked out and you have two options: run away, leaving %s for dead, or fight, protecting %s till your last breath.", itsname, itsname, itsname, itsname);
	...
	else if (random_number >= 10 && current == 1)
		;
	{
		printf("%s releases a beam of energy directly into the creatures head, killing it instantly. ", itsname);
	}
	...
	case 1:
		...
		break;
	case 2:
		printf("You turn and walk away from %s. You feel this heartbreak and guilt, like your soul is being ripped from your body, but you press on. In the distance is another door; you reach it, open the door, and escape.", itsname);
		break;
	}
}
...
void omarsUniqueFn(void)
{
	...
	for (round = 1; round <= 5 && health > 0; ++round)
	{
		...
		if (strlen(input) == 1 && input[0] == target)
		{
			...
			{
			case 1:
				printf("A spectral shield briefly materializes around you.\n");
				break;
			case 2:
				printf("The temperature in the room grows pleasantly warm.\n");
				break;
			case 3:
				printf("Ghostly butterflies flutter around the room in celebration.\n");
				break;
			case 4:
				printf("A soothing melody begins playing from unseen instruments.\n");
				break;
			case 5:
				printf("Golden light fills the chamber, and the air smells of honey and spice.\n");
				break;
			}
		}
		else
		...
		case 1:
			...
			if (!found_box)
			{
				...
				if (observation_count < 5)
					strcpy(observations[observation_count++], "Found a strange metal box on the tray.");
				sleep(1);
			}
			...
			if (!has_scalpel && (rand() % 2 == 0))
			{
				...
				if (observation_count < 5)
					strcpy(observations[observation_count++], "Found a rusty scalpel.");
				sleep(1);
			}
			...
			if (!has_key && (rand() % 3 == 0))
			{
				...
				has_key = true;
				if (observation_count < 5)
					strcpy(observations[observation_count++], "Found a brass key on the medical tray.");
			}
			else if (!has_key)
			{
			...
			if (observation_count < 5)
				strcpy(observations[observation_count++], "Examined the creepy medical tray.");
			sleep(1);
			...
			for (attempts = 0; attempts < 3; attempts++)
			{
				...
				else
				{
					...
					if (attempts < 2)
						...
						printf("Trying the door seems futile without a key.\n");
				}
			}
		...
		case 6:
			if (found_box)
			{
				...
				if (has_key && has_scalpel)
				{
					...
					if (observation_count < 5)
						strcpy(observations[observation_count++], "Opened the metal box using the key and scalpel! Found a finger.");
				}
				else if (has_key && !has_scalpel)
				{
					...
					if (observation_count < 5)
						strcpy(observations[observation_count++], "Touched the key to the box. Etchings glowed.");
				}
				else if (!has_key && has_scalpel)
				{
					...
					if (observation_count < 5)
						strcpy(observations[observation_count++], "Tried to pry the box with the scalpel; the scalpel broke.");
				}
				else
				{
					...
					if (observation_count < 5)
						strcpy(observations[observation_count++], "Examined the metal box. Couldn't interact further.");
				}
