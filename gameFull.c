...
void printScoreboard(int successArray[]);
...
void alexGameRoom56(void)
{
    ...
    while (completedCount < 5)
    {
        ...
        {
            printf("Mission Failed. The correct number was %d. Task %d still completed! However you will not have your items/intel from the task since-\n", secretNumbers[choice - 1], choice);
    ...
    printScoreboard(correctGuesses);
...
void checkDoorStatus(int successCount)
{
    if (successCount == 5) //Special Unique Feature of the game. If you succeed in all 5 tasks, you are greeted with a thumbs up in ASCII art.
    {
        printf("\n╔══════════════════════════════════════════════════════════╗\n");
        printf("   You are a master operative and have successfully finished all\n");
        printf("   5 tasks successfully. Well Done!\n");
        printf("╚════════════════════════════════════════════════════════════╝\n");
